class RadioCli < Formula
  ...
  url "https://github.com/schlunsen/radio-cli/archive/refs/tags/v0.8.3.tar.gz"
  sha256 "f42d631cc812be7a8c64dc49b719c928b4d22b55916903b34b223cbabc33c091"
  license "MIT"
  head "https://github.com/schlunsen/radio-cli.git", branch: "master"
  
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/schlunsen/radio-cli/releases/download/v0.8.3/radio_cli-macos-amd64"
      sha256 "f42d631cc812be7a8c64dc49b719c928b4d22b55916903b34b223cbabc33c091"
    end
